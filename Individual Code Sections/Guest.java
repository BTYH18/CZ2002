...
public class Guest {
	...
	public Guest(String name, String country, String gender, String address, String idType, int idNum, int contact, String payType, String nameOnCard, int cardNum, String billAddress) {
		this.name = name;
	...
	public void setIdentity(String newIdType, int newIdNum) {
