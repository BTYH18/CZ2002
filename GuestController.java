...
public class GuestController {
	...
	public GuestController() {
		...
		File tempFile = new File("C:\\Users\\anton\\eclipse-workspace\\assignemnt\\filename.txt");
		if (tempFile.exists()) {
			loadData("C:\\Users\\anton\\eclipse-workspace\\assignemnt\\filename.txt");
		}
//		 try
//		 {
...
//			}
		...
		private static void loadData(String savedFile) 
		{
			String name;
			String country;
			String gender;
		...
		public static void main(String[] args) {
			 guests = new ArrayList<Guest>();
			 sc = new Scanner(System.in);
			 GuestController.loadData("C:\\Users\\anton\\eclipse-workspace\\assignemnt\\filename.txt");
