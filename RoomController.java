...
public class RoomController {
	...
	//reading room.txt,writting array list as a object into file
    public static void saveData() {
        try {

            FileOutputStream file = new FileOutputStream(stored_File_Name); //reading file
	...
	// read from file, save as array
    public static void loadData() {
        try {
            // Reading the object from a file
            FileInputStream file = new FileInputStream(stored_File_Name);
            ...
            System.out.println("De-Serialized the Object ");
            for (int counter = 0; counter < rooms.size(); counter++) {
                System.out.println(rooms.get(counter));
            }
